...
use crate::bootstrap::{
    ...
    PG_CLASS_PAGE_ID, PG_CLASS_TABLE_ID,
};
...
impl Catalog {
    ...
    pub fn get_table(&self, name: &str) -> Option<TableDef> {
        ...
        let tuples = self.read_table_tuples(PG_CLASS_PAGE_ID, &pg_class_schema).ok()?;
    ...
    pub fn next_table_id(&self) -> Result<u32> {
        ...
        let mut max_id: u32 = 1; // At least pg_class(0) and pg_attribute(1) exist
        for values in tuples {
